...
BRAND_ELEMENTS = (
    f'<rect x="1" y="1" width="62" height="62" rx="14" fill="{BRAND_VOID}" '
    f'stroke="{BRAND_LINE}" stroke-opacity=".24" stroke-width="2"/>',
    f'<path d="M32 9 50 19 32 29 14 19 32 9Z" fill="{BRAND_TOP}"/>',
    f'<path d="M14 19 32 29v21L14 40V19Z" fill="{BRAND_LEFT}"/>',
    f'<path d="M32 29 50 19v21L32 50V29Z" fill="{BRAND_RIGHT}"/>',
    '<path d="M32 9 50 19v21L32 50 14 40V19L32 9Z'
    'm0 20L14 19m18 10 18-10M32 29v21" '
    f'fill="none" stroke="{BRAND_VOID}" stroke-linecap="round" '
    'stroke-linejoin="round" stroke-width="2"/>',
    f'<circle cx="52" cy="13.5" r="8.25" fill="{BRAND_VOID}" '
    f'stroke="{BRAND_ACCENT}" stroke-width="2"/>',
    '<path d="M47.25 20v-11h4.5c2.6 0 4.2 1.35 4.2 3.55 0 1.55-.82 '
    '2.75-2.25 3.28l2.7 4.17h-3.1L51 16.4h-1V20h-2.75ZM50 '
    '14.15h1.5c1.1 0 1.68-.46 1.68-1.32 0-.85-.58-1.3-1.68-1.3H50'
    f'v2.62Z" fill="{BRAND_ACCENT}" '
    'transform="translate(52 13.5) scale(.82) translate(-51.5 -14)"/>',
)
...
def social_card_svg(
    *,
    ...
    return (
        ...
        f'font-weight="700" fill="{BRAND_LEFT}">$ whoami</text>\n'
        ...
        f'    <circle cx="6" cy="-6" r="6" fill="{BRAND_ACCENT}"/>\n'
